...
- [CoPaw](#copaw)
  ...
  - [Быстрый старт](#быстрый-старт)
    - [Вариант 1: pip install](#вариант-1-pip-install)
    - [Вариант 2: Установка через скрипт](#вариант-2-установка-через-скрипт)
    - [Вариант 3: Использование Docker](#вариант-3-использование-docker)
    - [Вариант 4: Развертывание на Alibaba Cloud ECS](#вариант-4-развертывание-на-alibaba-cloud-ecs)
    - [Вариант 5: Использование ModelScope](#вариант-5-использование-modelscope)
    - [Вариант 6: Десктопное приложение (Beta)](#вариант-6-десктопное-приложение-beta)
      - [Загрузка](#загрузка)
      - [Особенности](#особенности)
      - [Первый запуск](#первый-запуск)
      - [macOS: Обход системных ограничений безопасности](#macos-обход-системных-ограничений-безопасности)
  - [API Key](#api-key)
